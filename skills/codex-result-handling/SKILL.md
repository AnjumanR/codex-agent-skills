...
- For `codex-rescue`, do not turn a failed or incomplete Codex run into your own implementation attempt. Report the failure and stop.
...
- If the helper reports that setup or authentication is required, direct the user to `node runtime/scripts/codex-companion.mjs setup` and do not improvise alternate auth flows.
